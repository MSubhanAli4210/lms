  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-12">
      <div className="animate-page-enter w-full max-w-md rounded-2xl border bg-white p-8 shadow-xl shadow-slate-900/5 sm:p-10">
        <div className="mb-8">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-teal-700">Start learning</p>
          <h1 className="text-3xl font-semibold tracking-tight text-slate-950">
          Create Account
          </h1>
          <p className="mt-2 text-sm text-slate-500">Build your personal learning space.</p>
        </div>
