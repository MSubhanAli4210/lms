  ...
  return (
    <section className="animate-page-enter min-h-screen px-6 py-12 sm:px-10">
      <div className="mx-auto max-w-5xl">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-teal-700">Your learning space</p>
        <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">Student Dashboard</h1>
